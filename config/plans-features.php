...
return [
    ...
    'meta' => [
        ...
        'rdv' => [
            ...
            'plan_requis' => 'premium',
            'icon' => 'calendar',
            'accroche' => 'Organisez votre agenda et ne ratez aucune cliente',
            'description' => 'Planifiez les rendez-vous de vos clientes, associez-y une ou plusieurs prestations, et recevez des rappels automatiques la veille.',
            'avantages' => [
                'Agenda par jour / semaine',
                'RDV liés aux fiches clientes',
                'Prestations multiples par RDV',
                'Rappel automatique J-1 par email et notification push',
