...
Route::middleware(['auth', 'abonnement.actif', 'email.verifie'])->prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::prefix('boutique')->name('boutique.')->group(function () {
        ...
        Route::middleware('role:admin,gerant')->group(function () {
            ...
            Route::post('commandes/{commande}/modifier', [CommandeController::class, 'update'])->name('commandes.update');
    ...
    Route::middleware('role:admin,gerant')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::get('mes-instituts/apparence', [MesInstitutsController::class, 'apparence'])->name('mes-instituts.apparence');
            Route::put('mes-instituts/apparence', [MesInstitutsController::class, 'updateApparence'])->name('mes-instituts.apparence.update');
            Route::post('mes-instituts/apparence/reset', [MesInstitutsController::class, 'resetApparence'])->name('mes-instituts.apparence.reset');
    ...
    Route::middleware('feature:clients')->group(function () {
        ...
        Route::get('clients/{client}/fiche-pdf', [ClientController::class, 'fichePdf'])->name('clients.fiche-pdf');
...
Route::middleware('auth')->prefix('abonnement')->name('abonnement.')->group(function () {
    ...
    Route::get('/facture/abonnement/{abonnement}', [AbonnementController::class, 'factureAbonnement'])->name('facture-abonnement');
    Route::get('/facture/transaction/{paymentTransaction}', [AbonnementController::class, 'factureTransaction'])->name('facture-transaction');
