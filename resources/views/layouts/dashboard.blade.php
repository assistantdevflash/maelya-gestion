...
<div class="flex h-full" x-data="{
    ...
    <div class="flex-1 flex flex-col min-w-0 lg:pl-[260px]">
        ...
        {{-- Topbar desktop --}}
        <header class="hidden lg:flex sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-gray-200/60 dark:border-slate-700/60 px-4 sm:px-6 lg:px-8 h-14 items-center justify-between">
