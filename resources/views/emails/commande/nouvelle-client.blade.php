...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
    ...
    <tr>
        <td style="padding:32px;">
            ...
            {{-- Tableau produits --}}
            <p style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:{{ $cp }};margin-bottom:12px;">Récapitulatif</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                    <td style="width:50%;vertical-align:top;padding-right:16px;">
                        <p style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:{{ $cp }};margin-bottom:8px;">📍 Adresse de livraison</p>
                        <p style="font-size:14px;color:#374151;margin:0;line-height:1.6;">{{ $commande->client_adresse }}</p>
                    </td>
                    <td style="width:50%;vertical-align:top;">
                        <p style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:{{ $cp }};margin-bottom:8px;">💳 Mode de paiement</p>
