...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
    ...
    {{-- HEADER --}}
    <tr>
        <td style="background:linear-gradient(135deg,#7c3aed,#6366f1);padding:36px 32px;text-align:center;">
            ...
            <h1 style="color:#fff;font-size:22px;font-weight:700;margin:0 0 6px;">Echeance credit demain</h1>
            <p style="color:rgba(255,255,255,0.85);font-size:14px;margin:0;">{{ $client?->nom_complet ?? 'Client' }} — {{ $date->translatedFormat('l d F Y') }}</p>
        </td>
    </tr>
