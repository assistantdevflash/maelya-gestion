...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
    ...
    <tr>
        <td bgcolor="{{ $cp }}" style="background-color:{{ $cp }};background:linear-gradient(135deg,{{ $cp }},{{ $cs }});padding:36px 32px;text-align:center;">
            ...
            <h1 style="color:#ffffff !important;font-size:22px;font-weight:700;margin:0 0 6px;">Votre rendez-vous est confirmé !</h1>
            <p style="color:rgba(255,255,255,0.85) !important;font-size:14px;margin:0 0 4px;">Bonjour {{ $rdv->client_nom }}, nous avons bien enregistré votre rendez-vous.</p>
    ...
    <tr>
        <td style="padding:32px;">
            <p style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:{{ $cp }};margin-bottom:12px;">Détails du rendez-vous</p>
