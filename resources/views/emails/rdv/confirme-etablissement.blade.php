...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
    ...
    {{-- HEADER --}}
    <tr>
        <td bgcolor="#6366f1" style="background-color:#6366f1;background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:36px 32px;text-align:center;">
            ...
            <h1 style="color:#ffffff !important;font-size:22px;font-weight:700;margin:0 0 6px;">Nouveau rendez-vous ajouté</h1>
