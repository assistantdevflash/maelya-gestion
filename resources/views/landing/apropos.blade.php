...
<section class="relative pt-32 pb-20 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 text-center animate-fade-in-up">
        ...
        <p class="text-lg text-white/50 mt-5 max-w-2xl mx-auto leading-relaxed">La solution de gestion conçue en Côte d'Ivoire, pensée pour les entrepreneurs et établissements de service africains.</p>
    </div>
