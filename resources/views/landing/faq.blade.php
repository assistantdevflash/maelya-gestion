    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        $categories = [
            ...
            ['Abonnements & Paiement', 'from-secondary-500 to-pink-600', 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', [
                ['Quels sont les plans disponibles ?', 'Nous proposons 5 plans :<br>• <strong>Essai gratuit</strong> — 0 FCFA/mois (14 jours, 1 employé, toutes les fonctionnalités)<br>• <strong>Premium</strong> — 4 900 FCFA/mois (1 établissement, jusqu\'à 3 employés, caisse illimitée, agenda & RDV, stock)<br>• <strong>Premium+</strong> — 9 900 FCFA/mois (jusqu\'à 3 établissements, jusqu\'à 10 employés par établissement, vente à crédit & échéanciers)<br>• <strong>Ultra</strong> — 24 900 FCFA/mois (établissements illimités, employés illimités, toutes les fonctionnalités)<br>Des réductions sont disponibles : <strong>−10% en annuel</strong> et <strong>−20% en triennal</strong>.'],
            ...
            ['Fonctionnalités', 'from-emerald-500 to-teal-600', 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z', [
                ['Combien d\'employés puis-je ajouter ?', 'Cela dépend de votre plan :<br>• <strong>Essai gratuit</strong> : 1 employé<br>• <strong>Premium</strong> : jusqu\'à 3 employés<br>• <strong>Premium+</strong> : jusqu\'à 10 employés par établissement (3 établissements max)<br>• <strong>Ultra</strong> : employés illimités<br>Chaque membre de l\'équipe a ses propres identifiants et un accès limité selon votre configuration.'],
                ...
                ['Puis-je gérer plusieurs établissements ?', 'Oui, avec les plans <strong>Premium+</strong> (jusqu\'à 3 établissements) ou <strong>Ultra</strong> (établissements illimités) ! Vous pouvez créer et gérer plusieurs établissements depuis le même compte, chacun avec ses propres employés, produits et statistiques.'],
                ['Puis-je vendre mes produits en ligne ?', 'Oui ! Avec le module <strong>Boutique en ligne</strong> (option à 3 900 F/mois), vos clientes peuvent commander vos produits directement depuis une page web dédiée. Vous gérez les commandes depuis le dashboard : accepter, préparer, livrer. Frais et zones de livraison personnalisables.'],
                ['Comment créer des devis et factures ?', 'Le module <strong>Devis & Factures</strong> (disponible dès Premium+) vous permet de créer des devis professionnels en quelques clics. Choisissez parmi vos prestations et produits, ajoutez remises et TVA, puis partagez un PDF par WhatsApp ou email. Transformez un devis accepté en facture en un clic, et suivez les paiements.'],
            ]],
