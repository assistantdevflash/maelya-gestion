    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        $categories = [
            ...
            ['Abonnements & Paiement', 'from-secondary-500 to-pink-600', 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', [
                ['Quels sont les plans disponibles ?', 'Nous proposons deux plans principaux :<br>• <strong>Premium</strong> — 4 900 FCFA/mois (jusqu\'au 3 employés, 1 établissement)<br>• <strong>Premium+</strong> — 9 900 FCFA/mois (employés et établissements illimités)<br>Des réductions sont disponibles : <strong>−10% en annuel</strong> et <strong>−20% en triennal</strong>.'],
