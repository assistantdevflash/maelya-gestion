    ...
    <div class="max-w-2xl mx-auto space-y-5">
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('dashboard.ventes.ticket-pdf', ['vente' => $vente, 'print' => '1']) }}" target="_blank" class="btn-outline w-full justify-center">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/>
                    </svg>
                    Imprimer le ticket
                </a>
                <a href="{{ route('dashboard.ventes.facture-pdf', ['vente' => $vente, 'print' => '1']) }}" target="_blank" class="btn-outline w-full justify-center">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
