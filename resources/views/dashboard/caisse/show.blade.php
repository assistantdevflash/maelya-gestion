            ...
            <div class="flex flex-col gap-3">
                ...
                <div x-data="printButton()">
                    <button @click="print('{{ route('dashboard.ventes.ticket-pdf', $vente) }}')" 
                        ...
                        <span x-text="loading ? 'Chargement...' : 'Imprimer le ticket'"></span>
                    </button>
                </div>
                <div x-data="printButton()">
                    <button @click="print('{{ route('dashboard.ventes.facture-pdf', $vente) }}')" 
                        ...
                        <span x-text="loading ? 'Chargement...' : 'Imprimer la facture'"></span>
                        @if($vente->numero_facture)
                            <span x-show="!loading" class="text-xs text-gray-500 ml-1">({{ $vente->numero_facture }})</span>
                        @endif
                    </button>
                </div>
                @else
