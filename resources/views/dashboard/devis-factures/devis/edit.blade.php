        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="card" style="overflow: visible">
                    ...
                    <div class="card-body space-y-3">
                        ...
                        <div class="text-right pt-1">
                            <button type="button" @click="ajouter()" class="inline-flex items-center gap-1.5 text-sm text-primary-600 hover:text-primary-700 font-medium transition">
            ...
            <div class="space-y-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body"><input type="text" name="titre" maxlength="200" value="{{ old('titre', $devis->titre) }}" placeholder="Ex: Mariage de Fatou, Pack coiffure..." class="form-input text-sm"></div>
                </div>
                <div class="card">
