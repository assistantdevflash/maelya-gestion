...
<div class="max-w-5xl mx-auto space-y-6" x-data="{}">
    ...
    <div class="flex flex-col gap-5">
        ...
        @php
            $whatsappMsg = urlencode("Bonjour, voici votre devis {$devis->numero} d'un montant de " . number_format($devis->total_ttc, 0, ',', ' ') . " F CFA.");
            $whatsappTel = $devis->client_telephone ? preg_replace('/[^0-9]/', '', $devis->client_telephone) : '';
        @endphp
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <x-dropdown-actions>
                ...
                @if($whatsappTel)
                <a href="https://wa.me/{{ $whatsappTel }}?text={{ $whatsappMsg }}" target="_blank"
                   class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition">
        ...
        <div class="md:col-span-2 card overflow-hidden">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                ...
                <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                    ...
                    <span>{{ $devis->client_telephone }}</span>
                </div>
                @endif
                ...
                <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400 col-span-full">
                    ...
                    <span>{{ $devis->client_adresse }}</span>
                </div>
                @endif
            </div>
        </div>
