                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="email" x-model="newClient.email" maxlength="255" class="form-input" placeholder="fatou@exemple.ci">
                        </div>
        ...
        async creerClient() {
            ...
            try {
                ...
                if (!res.ok) {
                    ...
                    this.newClientError = err.message || 'Erreur lors de la création.';
                    return;
                }
                ...
                this.newClientError = 'Erreur réseau. Réessayez.';
            } finally {
