...
<div class="max-w-5xl mx-auto space-y-6">
    @php
        ...
        $whatsappMsg = urlencode("Bonjour, voici votre facture {$facture->numero} d'un montant de " . number_format($facture->total_ttc, 0, ',', ' ') . " F CFA.");
        $whatsappTel = $facture->client_telephone ? preg_replace('/[^0-9]/', '', $facture->client_telephone) : '';
    @endphp
