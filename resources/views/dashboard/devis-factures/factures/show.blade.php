...
<div class="max-w-5xl mx-auto space-y-6">
    @php
        ...
        $mailtoSubject = urlencode("Facture {$facture->numero}");
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            {{-- WhatsApp (toujours visible si tel client) --}}
            @if($whatsappTel)
            ...
            <x-dropdown-actions>
                ...
                <a href="mailto:{{ $facture->client_email }}?subject={{ $mailtoSubject }}&body={{ $mailtoBody }}"
                   class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition">
