    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <div class="card p-4 flex items-center gap-4 hover:shadow-md transition-shadow group">
                    {{-- Heure --}}
                    ...
                    <div class="flex items-center gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                        <a href="{{ route('dashboard.rdv.show', $rdv) }}" class="btn-icon text-gray-400 hover:text-primary-600" title="Voir">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
