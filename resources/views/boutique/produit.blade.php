        ...
        <div x-data="{ activeImg: '{{ $galleryImages->first()?->chemin ?? $produit->photo }}' }">
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="https://wa.me/?text={{ urlencode($produit->nom . ' — ' . $ogUrl) }}"
                    ...
                    <span x-data="{ copied: false }" class="inline-flex items-center gap-2">
                        <button @click="navigator.clipboard.writeText('{{ $ogUrl }}'); copied = true; setTimeout(() => copied = false, 2000)"
                        ...
                        <span x-show="copied" x-cloak class="text-xs font-semibold text-emerald-600">✓ Copié !</span>
                    </span>
                </div>
            </div>
        </div>
