...
<body class="boutique-soft dark:bg-slate-900 min-h-screen flex items-center justify-center p-4">
    <div class="text-center max-w-md">
        ...
        <a href="/shop/{{ $institut->slug }}" class="boutique-btn inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-colors">
