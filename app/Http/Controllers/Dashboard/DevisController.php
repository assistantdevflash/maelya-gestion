...
class DevisController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.devis.show', ['devi' => $devis->id])->with('success', 'Devis créé avec succès.');
    }
    ...
    public function update(Request $request, Devis $devis)
    {
        ...
        return redirect()->route('dashboard.devis.show', ['devi' => $devis->id])->with('success','Devis mis à jour.');
    }
    ...
    public function dupliquer(Devis $devis) {
        ...
        return redirect()->route('dashboard.devis.show', ['devi' => $new->id])->with('success','Devis dupliqué.');
    }
}
