...
class FactureItem extends Model
{
    ...
    protected $fillable = ['facture_id','produit_id','prestation_id','designation','quantite','prix_unitaire','remise_type','remise_valeur','tva_taux','total_ligne','ordre'];
    protected $casts = ['quantite'=>'integer','prix_unitaire'=>'integer','remise_valeur'=>'integer','tva_taux'=>'decimal:2','total_ligne'=>'integer','ordre'=>'integer'];
